...
Websites::Application.routes.draw do
  ...
  # Reorder routes for controller "categories"
  ...
  get 'manual_assignments(.:format)' => 'manual_assignments#index', :as => 'manual_assignments'
  get 'manual_assignments/new(.:format)', :as => 'new_manual_assignment'
  get 'manual_assignments/:id/edit(.:format)' => 'manual_assignments#edit', :as => 'edit_manual_assignment'
  ...
  # Reorder routes for controller "manual_assignments"
  ...
  get 'machine_assignments/:id/edit(.:format)' => 'machine_assignments#edit', :as => 'edit_machine_assignment'
  ...
  # Reorder routes for controller "machine_assignments"
  ...
  get 'features/:id/edit(.:format)' => 'features#edit', :as => 'edit_feature'
